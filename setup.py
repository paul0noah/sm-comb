...
class CMakeExtension(Extension):
    def __init__(self, name, sourcedir='c++'):
...
setup(
    name='SM-comb',
    version='0.0.1',
    description='Bindings for Combinatorial Solver for ShapeMatchMatching',
    packages=find_packages('./'),
    package_dir={'':'./'},
    #ext_package='BDD',
    ext_modules=[CMakeExtension(name='shape_match_model_pb')],
